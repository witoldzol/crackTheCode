...
** TODO Charge camera battery
** TODO Check camera memory 
** TODO Sell camera
** TODO Sell tripod
** TODO Sell speakers
** TODO Sell Suzuki
...
* Dealing with square:
Once you figure out edge case, and normal case, all you have to do it apply
recursion. I have this problem of sqare, and shifting it by 90 degrees, but
I DON'T want to use recursion due to time complexity it entails...wait would't 
it be unnecesary ? it only deals with edge cases ? I have to think about it...
